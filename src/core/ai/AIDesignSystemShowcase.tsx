...
const AIDesignSystemShowcase: React.FC<AIDesignSystemShowcaseProps> = ({
  ...
  return (
    <div className={`ai-design-showcase ${className}`}>
        ...
        <div className="col-12">
          <div className="ai-card">
            <div className="ai-card__header">
              ...
              <p className="mb-0 mt-1" style={{fontSize: 'var(--ai-font-sm)', color: 'var(--ai-text-muted)'}}>
            ...
            <div className="ai-card__body">
              ...
              {activeSection === 'badges' && (
                <div className="row g-4">
                  <div className="col-md-6">
                    <h6 className="fw-semibold mb-3" style={{color: 'var(--ai-text-primary)'}}>Priority Levels</h6>
                    ...
                    <h6 className="fw-semibold mb-3" style={{color: 'var(--ai-text-primary)'}}>Size Variants</h6>
                    <div className="d-flex flex-wrap gap-2 mb-3">
                  ...
                  <div className="col-md-6">
                    <h6 className="fw-semibold mb-3" style={{color: 'var(--ai-text-primary)'}}>Status Indicators</h6>
                    <div className="d-flex flex-wrap gap-2 mb-3">
                    ...
                    <div className="ai-list-item">
                      ...
                      <div className="ai-list-item__content">
                        ...
                        <p className="mb-0" style={{fontSize: 'var(--ai-font-sm)', color: 'var(--ai-text-muted)'}}>
              ...
              {activeSection === 'buttons' && (
                <div className="row g-4">
                  <div className="col-md-6">
                    <h6 className="fw-semibold mb-3" style={{color: 'var(--ai-text-primary)'}}>Button Variants</h6>
                    <div className="d-flex flex-wrap gap-2 mb-3">
                    ...
                    <h6 className="fw-semibold mb-3" style={{color: 'var(--ai-text-primary)'}}>Action Buttons</h6>
                    <div className="d-flex flex-wrap gap-2 mb-3">
                  ...
                  <div className="col-md-6">
                    <div className="ai-card">
                      ...
                      <div className="ai-card__body">
                        ...
                        <p className="mb-2" style={{fontSize: 'var(--ai-font-sm)', color: 'var(--ai-text-muted)'}}>
                          Based on doctor availability and patient preferences
                        </p>
                        <div className="ai-progress">
                          <div className="ai-progress__bar ai-progress__bar--success" style={{width: `${mockSuggestion.score}%`}}></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="ai-list-item__content">
                      <div className="d-flex justify-content-between align-items-start">
                        ...
                        <div className="text-end">
                          ...
                          <div className="text-muted" style={{fontSize: 'var(--ai-font-xs)'}}>89% confidence</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ai-list-item">
                    ...
                    <div className="ai-list-item__content">
                      <div className="d-flex justify-content-between align-items-start">
                        ...
                        <div className="text-end">
                          <span className="ai-badge ai-badge--high">High</span>
                          <div className="text-muted" style={{fontSize: 'var(--ai-font-xs)'}}>76% confidence</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ai-list-item">
                    ...
                    <div className="ai-list-item__content">
                      <div className="d-flex justify-content-between align-items-start">
                        ...
                        <div className="text-end">
                          <span className="ai-badge ai-badge--low">Low</span>
                          <div className="text-muted" style={{fontSize: 'var(--ai-font-xs)'}}>95% confidence</div>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="ai-card__body" style={{padding: 'var(--ai-space-3)'}}>
                          <div className="d-flex align-items-center">
                            <div className="me-3 flex-shrink-0" style={{
                              ...
                              height: '32px',
                              borderRadius: '50%',
                              background: `var(--ai-${metric.color === 'success' ? 'low' : 'medium'}-bg)`,
                              color: `var(--ai-${metric.color === 'success' ? 'low' : 'medium'})`,
                              display: 'flex',
                              alignItems: 'center',
                            ...
                            <div className="flex-grow-1">
                              <div className="d-flex align-items-center justify-content-between mb-1">
                                <p className="mb-0" style={{fontSize: 'var(--ai-font-xs)', color: 'var(--ai-text-muted)'}}>
                                  {metric.title}
                                </p>
                                {metric.trend && (
                                  <span className="ai-badge ai-badge--low" style={{fontSize: 'var(--ai-font-xs)'}}>
                                    ↗ {metric.trendValue}
                                  </span>
                                )}
                              </div>
                              <h4 className="mb-1 fw-bold" style={{color: 'var(--ai-text-primary)'}}>
                                {metric.value}
                              </h4>
                              <div className="ai-progress">
                                <div
                              ...
                              {metric.description && (
                                <p className="mb-0 mt-1" style={{fontSize: 'var(--ai-font-xs)', color: 'var(--ai-text-muted)'}}>
                                  {metric.description}
                                </p>
                              )}
                            </div>
      ...
      <div className="ai-card mt-4" style={{borderColor: 'var(--ai-accent)'}}>
        <div className="ai-card__header" style={{background: 'var(--ai-accent)', color: 'var(--ai-text-inverse)'}}>
          <h6 className="mb-0 fw-semibold">🚀 Implementation Notes</h6>
        </div>
        <div className="ai-card__body">
          <div className="row g-4">
            <div className="col-md-6">
              <h6 className="fw-semibold" style={{color: 'var(--ai-text-primary)'}}>Key Improvements</h6>
            ...
            <div className="col-md-6">
              <h6 className="fw-semibold" style={{color: 'var(--ai-text-primary)'}}>Design Tokens</h6>
              <div className="d-flex flex-wrap gap-1 mb-2">
                <code style={{fontSize: 'var(--ai-font-xs)', background: 'var(--ai-bg-secondary)', padding: '2px 4px', borderRadius: '3px'}}>--ai-primary</code>
                <code style={{fontSize: 'var(--ai-font-xs)', background: 'var(--ai-bg-secondary)', padding: '2px 4px', borderRadius: '3px'}}>--ai-accent</code>
                <code style={{fontSize: 'var(--ai-font-xs)', background: 'var(--ai-bg-secondary)', padding: '2px 4px', borderRadius: '3px'}}>--ai-space-*</code>
              </div>
              <p className="mb-0" style={{fontSize: 'var(--ai-font-sm)', color: 'var(--ai-text-muted)'}}>
